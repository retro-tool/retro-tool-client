  ...
  <>
    ...
    <Box bg="white" margin="auto">
      ...
      <Flex as="main" flexDirection="column">
        ...
        <Section bg="violet" color="white" py={[8, null, null, 80, 100]} px={7}>
          <Box maxWidth="100ch" margin="auto">
            ...
            <Flex justifyContent="space-between" flexWrap="wrap">
              ...
              >
                <Mobile height={32} />
                <Text as="h3" mt={5} mb={4} textStyle="landingHighlightsTitle">
                  Easy peasy
                </Text>
        ...
        <Box
          ...
          overflow="hidden"
        >
          <Box width="100ch" maxWidth="100%" margin="auto" position="relative">
            ...
            >
              ...
              <Text fontSize={[4, null, 5]} color="grey" my={4}>
                The main and only screen is a 4 columns layout where you can add
                different topics and action items (unless you are on tablet or
              ...
              <Text textStyle="landingBase" mt={1} mb={8}>
                ...
                <em>questions</em>, usually this step is done asynchronously. A
                good idea is to share the retro url some days before the retro
                meeting.
              </Text>
